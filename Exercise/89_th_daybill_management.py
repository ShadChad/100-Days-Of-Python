...
Label(f,font=("Lucide Calligraphy",15,'bold'),text="Tea..........Rs.70/plate",fg="black",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucide Calligraphy",15,'bold'),text="Coffee.......Rs.120/plate",fg="black",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucide Calligraphy",15,'bold'),text="Juice........Rs.40/plate",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucide Calligraphy",15,'bold'),text="Pancakes.....Rs.110/plate",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucide Calligraphy",15,'bold'),text="Eggs.........Rs.150/plate",fg="black",bg="lightgreen").place(x=10,y=260)
